  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        {/* Hero Section */}
        <section className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-purple-50 via-indigo-50 to-white">
          <div className="max-w-7xl mx-auto">
            <div className="text-center max-w-4xl mx-auto">
              {/* Badge */}
              <div className="inline-flex items-center px-4 py-2 bg-purple-100 text-primary rounded-full mb-8">
                <Shield className="w-4 h-4 mr-2" />
                <span className="text-sm font-medium">Safe • Secure • Confidential</span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                <button className="px-8 py-4 bg-gradient-purple text-white rounded-lg font-semibold hover:opacity-90 transition-opacity duration-200 shadow-lg">
                  Download on App Store
                  <span className="block text-sm font-normal opacity-90">Coming Soon</span>
                </button>
                <button className="px-8 py-4 bg-white text-primary border-2 border-primary rounded-lg font-semibold hover:bg-purple-50 transition-colors duration-200">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {features.map((feature, index) => (
                ...
                >
                  <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center text-primary mb-4">
                    {feature.icon}
                  </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {providerTypes.map((provider, index) => (
                <div
                  key={index}
                  className="flex flex-col items-center p-6 bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl hover:shadow-md transition-shadow duration-200"
                >
                  <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center text-primary mb-4 shadow-sm">
                    {provider.icon}
                  </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <h2 className="text-3xl font-bold mb-6">For Survivors</h2>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-semibold mb-1">Safe & Anonymous</h3>
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-semibold mb-1">Coordinated Care</h3>
                      <p className="text-gray-300 text-sm">
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-semibold mb-1">Always There</h3>
                      <p className="text-gray-300 text-sm">
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-semibold mb-1">Intelligent Case Routing</h3>
                      <p className="text-gray-300 text-sm">
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-semibold mb-1">Multi-Provider Coordination</h3>
                      <p className="text-gray-300 text-sm">
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-purple">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="px-8 py-4 bg-white text-primary rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-200 shadow-lg">
                Download on App Store
